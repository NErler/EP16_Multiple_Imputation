...
\only<3>{
<<regimp_movie, fig.show='animate', interval=1/10, fig.width = 5.25, fig.height = 3.5, include = FALSE, cache = TRUE>>=
regimp_movie

@

\animategraphics[loop, autoplay, width = \linewidth]{10}{figure/regimp_movie-}{1}{49}
}
\end{column}
\end{columns}
\end{frame}
...
\only<beamer>{
\only<-1>{
<<reglines_movie, fig.show='animate', interval=1/50, fig.width = 5.25, fig.height = 3.5, include = FALSE, cache = TRUE>>=
reglines_movie

@

\animategraphics[loop, autoplay, width = \linewidth]{5}{figure/reglines_movie-}{1}{50}
}}
\only<2->{
<<regimps_movie, fig.show='animate', interval=1/10, fig.width = 5.25, fig.height = 3.5, include = FALSE, cache = TRUE>>=
regimps_movie
@

\animategraphics[loop, autoplay, width = \linewidth]{10}{figure/regimps_movie-}{1}{100}
}
\end{column}
\end{columns}
\end{frame}
...
\only<beamer>{
\only<1>{
<<ranerrplot, echo = FALSE, fig.width = 5.25, fig.height = 3.75>>=
ranerrplot
@
}
\only<2>{
<<ranerr_movie, fig.show='animate', interval=1/10, fig.width = 5.25, fig.height = 3.75, include = FALSE, cache = TRUE>>=
ranerr_movie
@
\animategraphics[loop, autoplay, width = \linewidth]{1}{figure/ranerr_movie-}{1}{10}
}}
\only<3>{
<<ranerrimpsplot, echo = FALSE, fig.width = 5.25, fig.height = 3.75>>=
ranerrimpsplot
@
}
...
\end{block}
\vfill
or find the \textbf{html version} of the quiz here:\\
\begin{block}{}
\centering\url{https://nerler.github.io/EP16_Multiple_Imputation/practical/quiz/Quiz_PartI.html}
\end{block}
\end{frame}
