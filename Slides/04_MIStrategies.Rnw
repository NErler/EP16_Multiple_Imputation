...
\section{Some final comments on MICE}
...
Furthermore, \blue{direct likelihood methods}, \blue{fully Bayesian methods}
(as implemented in \textbf{JointAI}) or \blue{weighted estimating equations}
