...
<<Part0, child="00_Intro.Rnw", eval = T>>=
@
...
<<Part2, child="02_Workflow.Rnw", eval = T>>=
@

\part{When MICE might fail}
<<Part3, child="03_WhenMICEfails.Rnw", eval = T>>=
@
...
\begin{frame}[plain,noframenumbering]
\hypersetup{colorlinks,linkcolor=, urlcolor=white}
  \begin{center}
