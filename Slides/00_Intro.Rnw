...
\begin{itemize}
\item How does multiple imputation work?
\item How does MICE/FCS work?\\
      \blue{\ding{225}} A look into the black box
\item Understanding sources of uncertainty
\item The 3 steps of multiple imputation
\end{itemize}
\end{tcolorbox}
...
\tcblower
\blue{Practical:} imputation with \textbf{mice}
\end{tcolorbox}
...
\end{itemize}
\tcblower
\blue{Practical:} imputation in complex settings
\end{tcolorbox}
