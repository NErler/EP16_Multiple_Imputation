...
\textbf{Recall:} the \blue{conditional} distributions
...
to the analysis of the imputed data.\bigskip
...
\begin{frame}[fragile]{\thesection. \insertsection}
\framesubtitle{\thesection.\thesubsection. \insertsubsection}
Pooling with \Rfct{mice::pool} is available for most types of models.\bigskip
