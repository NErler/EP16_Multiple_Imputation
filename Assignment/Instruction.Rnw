...
Assignments need to be sumbitted via Canvas no later than \textcolor{red}{xx june 2018}
...
\item that you chose an appropriate imputation approach:
      ...
      (\textbf{JointAI}, \textbf{smcfcs} or \textbf{jomo}), but using
...
knit2pdf("Assignment/Instruction.Rnw",
