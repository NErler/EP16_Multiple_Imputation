...
\section*{Data}
The \textbf{MIdat23} data comprise data of 992 liver transplant patients
...
knit2pdf("Assignment/MIdat23_documentation.Rnw",
         output = "Assignment/instructions/MIdat23_documentation.tex")
file.remove("Assignment/instructions/MIdat23_documentation.tex")
@
\end{document}
