...
```{r Q5}
question("Why can we not just use the predicted values (e.g., $y_{mis} = X_{mis} \\beta$) as imputations?",
         answer("Predicting the same missing value multiple times will always result in the same value.", correct = TRUE),
...
```{r Q6}
question("How can results from analysis performed on multiply imputed data be combined?",
...
## Section 5
```{r Q5-1}
question("Good methods to draw imputations should take into account",
         answer("parameter uncertainty and predition error", correct = TRUE),
         answer(""),
         answer(""),
         answer(""),
         allow_retry = TRUE, random_answer_order = TRUE, type = "multiple")
...
question("Bootstrap multiple imputation",
         ...
         answer("creates replica of the original, incomplete data select imputed values"),
         answer("creates replica of the original, incomplete data to estimate parameter uncertainty", correct = TRUE),
         allow_retry = TRUE, random_answer_order = TRUE, type = "multiple")
```

```{r Q5-3}
question("Predictive mean matching requires several choices",
         answer("donor selection, matching type, prediction set", correct = TRUE),
         answer(""),
         answer(""),
         answer(""),
         allow_retry = TRUE, random_answer_order = TRUE, type = "multiple")
